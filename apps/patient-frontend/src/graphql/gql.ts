...
const documents: Documents = {
    "\n  mutation ValidateInviteToken($invite_token: String!) {\n    validateInviteToken(invite_token: $invite_token) {\n      valid\n      public_key_pem\n      organization_name\n      patient_record_id\n      expires_at\n      error_message\n    }\n  }\n": types.ValidateInviteTokenDocument,
    "\n  mutation SubmitPatientConsent(\n    $invite_token: String!\n    $consent_data: ConsentInput!\n  ) {\n    submitPatientConsent(\n      invite_token: $invite_token\n      consent_data: $consent_data\n    ) {\n      success\n      patient_consent_id\n      error\n    }\n  }\n": types.SubmitPatientConsentDocument,
    "\n  mutation SubmitPatientPersonalData(\n    $invite_token: String!\n    $patient_data: PatientPersonalDataInput!\n  ) {\n    submitPatientPersonalData(\n      invite_token: $invite_token\n      patient_data: $patient_data\n    ) {\n      success\n      patient_record_id\n      message\n      error\n    }\n  }\n": types.SubmitPatientPersonalDataDocument,
 ...
 */
export function graphql(source: "\n  mutation ValidateInviteToken($invite_token: String!) {\n    validateInviteToken(invite_token: $invite_token) {\n      valid\n      public_key_pem\n      organization_name\n      patient_record_id\n      expires_at\n      error_message\n    }\n  }\n"): typeof import('./graphql').ValidateInviteTokenDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation SubmitPatientPersonalData(\n    $invite_token: String!\n    $patient_data: PatientPersonalDataInput!\n  ) {\n    submitPatientPersonalData(\n      invite_token: $invite_token\n      patient_data: $patient_data\n    ) {\n      success\n      patient_record_id\n      message\n      error\n    }\n  }\n"): typeof import('./graphql').SubmitPatientPersonalDataDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
