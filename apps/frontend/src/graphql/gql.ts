...
const documents: Documents = {
    ...
    "\n  query GetPatientRecord($id: String!) {\n    patient_record_by_pk(id: $id) {\n      id\n      clinic_internal_id\n      first_name_encrypted\n      created_at\n      patient_data_completed_at\n      viewed\n      invite_expires_at\n      patient_consent {\n        consent_given\n      }\n      userByLastViewedBy {\n        id\n        name\n        email\n      }\n    }\n  }\n": types.GetPatientRecordDocument,
    "\n  mutation UpdateViewed($id: String!) {\n    update_patient_record_by_pk(\n      pk_columns: { id: $id }\n      _set: { viewed: true }\n    ) {\n      id\n      viewed\n    }\n  }\n": types.UpdateViewedDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation DeletePatientRecord($id: String!) {\n    update_patient_record_by_pk(\n      pk_columns: { id: $id }\n      _set: { deleted_at: \"now()\" }\n    ) {\n      id\n    }\n  }\n"): typeof import('./graphql').DeletePatientRecordDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query GetPatientRecord($id: String!) {\n    patient_record_by_pk(id: $id) {\n      id\n      clinic_internal_id\n      first_name_encrypted\n      created_at\n      patient_data_completed_at\n      viewed\n      invite_expires_at\n      patient_consent {\n        consent_given\n      }\n      userByLastViewedBy {\n        id\n        name\n        email\n      }\n    }\n  }\n"): typeof import('./graphql').GetPatientRecordDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation UpdateViewed($id: String!) {\n    update_patient_record_by_pk(\n      pk_columns: { id: $id }\n      _set: { viewed: true }\n    ) {\n      id\n      viewed\n    }\n  }\n"): typeof import('./graphql').UpdateViewedDocument;
