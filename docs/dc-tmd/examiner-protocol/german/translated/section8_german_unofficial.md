# 8 Erforderliche Untersuchungsanweisungen
...
Die Nummerierung der Unterabschnitte folgt der der untersuchungsbezogenen Schmerzbefragung (Abschnitt 6)
...
- FALLS JA zu Schmerz: Weiter zu ABFRAGE BEKANNTER SCHMERZ.

### 6.2.3 Für knackbezogenen Schmerz

- **War dieses Knacken schmerzhaft?**
- FALLS JA zu Schmerz: Weiter zu ABFRAGE BEKANNTER SCHMERZ.
...
- FALLS JA ZU BEKANNTEM SCHMERZ: **Wovon ist dieser Schmerz Ihnen bekannt?**
- FALLS DIE TEMPORALIS-LOKALISATION POSITIV IST: **Ist dieser Schmerz Ihnen bekannt von Kopfschmerzen, die Sie in diesem Bereich in den letzten 30 Tagen hatten?**
- Der Untersucher bestätigt, dass die berichteten Schmerzbereiche in den letzten 30 Tagen mit den als positiv für bekannten Schmerz berichteten Bereichen übereinstimmen.

### 6.2.5 Abfrage übertragener Schmerz

- **Haben Sie den Schmerz nur unter meinem Finger gespürt, oder auch irgendwo anders [in anderen Bereichen Ihres Kopfes, Gesichts oder Kiefers]?**
...
## 8.3 Erforderliche Komponenten aus Abschnitt 5: Vollständige Anweisungen des Untersuchers

**KONVENTIONEN FÜR DIESE TABELLE:** Fetter Text unter „Verbale Anweisung" muss wörtlich verwendet werden; Verfahren, die mit Zellen mit fettem Text verbunden sind, erfordern möglicherweise zusätzliche (gewöhnliche) Sprache für die Vervollständigung des Verfahrens. Leere Zellen unter „Verbale Anweisung" zeigen an, dass gewöhnliche Sprache für das gesamte Verfahren ausreichend ist; nicht fetter Text wird ebenfalls verwendet, um den Gebrauch gewöhnlicher Sprache im Zusammenhang mit bestimmten Verfahren zu veranschaulichen. Verfahren mit \<keine\> unter „Verbale Anweisung" zeigen an, dass es keine verbale Anweisung vom Untersucher gibt.

| KONSTRUKT | VERBALE ANWEISUNG |
|-----------|-------------------|
...
| *Submandibulärer Bereich* | **Bitte entspannen Sie Ihren Kiefer.** |
| *Bereich des lateralen Pterygoid* | **Öffnen Sie leicht und bewegen Sie Ihren Kiefer zur Seite.** |
| *Temporalissehne* | **Öffnen Sie Ihren Mund.** |
| **U11. Kommentare des Untersuchers** | |
| *Untersuchungskommentare* | \<keine\> |
