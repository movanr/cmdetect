...
#### Position des Lineals für Messung vertikaler Bewegungen
...
*Alternatives Format:*
*Im Englischen ist der Ausdruck "öffnen Sie so weit Sie können" üblich. In anderen Sprachen kann dies abweichen, z.B. ist „so sehr wie Sie können" in anderen Sprachen oftmals gebräuchlicher*
...
- Die maximale nicht-unterstützte Öffnung kann oft direkt ohne zwischenzeitlichen Kieferschluss nach der Messung der schmerzfreien Öffnung beurteilt werden
...
> - 6.2.1: Bewegungsinduzierter Schmerz
> - 6.2.4: Bekannter Schmerz

**Untersuchungsverfahren:**

- Bestätigen Sie die anatomischen Strukturen, die der Patient als schmerzhaft angegeben hat.
- Notieren Sie diesen Befund.
...
> Gleich werde ich versuchen, [wenn möglich] Ihren Mund mit meinen Fingern noch weiter zu öffnen. Wenn Sie möchten, dass ich aufhöre, heben Sie bitte Ihre Hand. Dann werde ich sofort aufhören.
...
> Ich platziere jetzt mein Lineal. [Pause]
>
...
- Positionieren Sie das Lineal wie unter 4A.
- Stellen Sie sicher, dass der Patient initial im gleichen Ausmaß öffnet wie bei der maximalen nicht-unterstützen Mundöffnung.
- Falls nicht, fordern Sie den Patienten auf, noch weiter zu öffnen.
...
- Notieren Sie, ob der Patient seine Hand gehoben hat, um die Öffnung abzubrechen
